...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
    ...
    \textbf{Mobile \& Cross-Platform}{: Flutter, Dart, Rust, Flutter Rust Bridge, local-first architecture, multi-platform packaging} \\
...
\resumeSubHeadingListStart
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{Local-first toolbox with \textbf{30+ utilities} spanning PDF, image, QR, OCR, storage, audio, and developer workflows. Published to Windows Store, Google Play (internal testing), and scheduled for Flathub (Linux flatpaks).}
