...
export default function CockpitChrome({ input, player, enemyCounts }: Props) {
  ...
  const isFirstPerson = cameraView === "first";
      ...
      {isFirstPerson && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-80">
          ...
          >
            ...
            <path d="M 85 95 L 85 85 L 95 85" fill="none" stroke="#38bdf8" strokeWidth="1.5" />
            <path d="M 115 95 L 115 85 L 105 85" fill="none" stroke="#38bdf8" strokeWidth="1.5" />
            <path d="M 85 105 L 85 115 L 95 115" fill="none" stroke="#38bdf8" strokeWidth="1.5" />
            <path d="M 115 105 L 115 115 L 105 115" fill="none" stroke="#38bdf8" strokeWidth="1.5" />
            <circle cx="100" cy="100" r="35" fill="none" stroke="rgba(56,189,248,0.3)" strokeWidth="1" strokeDasharray="4 6" />
            <path d="M 60 100 L 75 100" fill="none" stroke="rgba(56,189,248,0.5)" strokeWidth="1.5" />
            <path d="M 125 100 L 140 100" fill="none" stroke="rgba(56,189,248,0.5)" strokeWidth="1.5" />
            <path d="M 65 120 L 75 120 M 75 120 L 75 125" fill="none" stroke="rgba(56,189,248,0.3)" strokeWidth="1" />
            <path d="M 135 120 L 125 120 M 125 120 L 125 125" fill="none" stroke="rgba(56,189,248,0.3)" strokeWidth="1" />
            <path d="M 65 80 L 75 80 M 75 80 L 75 75" fill="none" stroke="rgba(56,189,248,0.3)" strokeWidth="1" />
            <path d="M 135 80 L 125 80 M 125 80 L 125 75" fill="none" stroke="rgba(56,189,248,0.3)" strokeWidth="1" />
          </svg>
        </div>
      )}
...
function DamageOverlay({
  ...
  useEffect(() => {
    ...
    const loop = () => {
      if (divRef.current) {
        const opacity =
          (1 - Math.max(0, Math.min(1, player.current.hull))) * 0.45;
        divRef.current.style.opacity = String(opacity);
        divRef.current.style.display = opacity > 0.005 ? "block" : "none";
      }
